...
<body>
	<form id="form1" method="post" action="${doUploadUrl}">
		...
		<div class="form-group">
			<button type="button" onclick="MulitUpload.btn_commit()"
				class="btn btn-primary">提交</button>
		</div>
	</form>
	<script src="${ctx}/assets/plugin/localResizeIMG3/lib/mobileFix.mini.js?v=8d13c59"></script>
	<script src="${ctx}/assets/plugin/localResizeIMG3/lib/exif.js?v=c65d9ea"></script>
	<script src="${ctx}/assets/plugin/localResizeIMG3/lrz.js?v=2869bec"></script>
	<script src="${ctx}/assets/js/mulit_upload_localResize.js"></script>
</body>
</html>